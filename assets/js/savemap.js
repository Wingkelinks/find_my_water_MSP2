...
function mapNSW() {
	...
	var detailWindow = new google.maps.InfoWindow({
		content: `<h1>New South Wales</h1><p>The majority of Australia's ocean pools are located in NSW. </p>`,
	});
	...
	var markers = nswMarkers.map(function (location) {
...
function mapQLD() {
	...
	var locations = [
		// 	// Queensland Pools
		{
			lat: -26.71103426866837,
			lng: 153.30404906522853,
		}, // Kings Beach
